...
```
.openclaw/alma/alma_agent.py (447 lines)
  - ALMAAgent class
  - MemoryDesign dataclass
  - EvaluationResult dataclass
  - Database-backed design storage
  - Meta-learning iteration logic

SELF_IMPROVING_ROADMAP.md (250+ lines)
  - Research foundation
  - 5-phase roadmap
  - Vision statement
  - Key references

alma_paom_integration.py (197 lines)
  - ALMAPAOSystem class
  - ALMA+PAOM integration
